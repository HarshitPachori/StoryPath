package com.example.storypath_backend.scheduler;
...
import com.example.storypath_backend.service.impl.SentimentAnalysisService;
...
public class AppScheduler {
    ...
    public void doSentimentAnalysisAndSendEmail() {
        ...
        for (User user : userForSentimentAnalysis) {
            ...
            // String sevenDaysContent = "I have been working for all day and become more
            // tired from monday to friday working days. It is worst experience for me.
            // Yesterday I got an email from one organisation for the job. This company
            // provides huge benefits and more things to their customers and employees, and
            // thus I decided to go out to this company and spend time there by networking
            // with more peoples.";
            if (sevenDaysContent.isEmpty())
                continue;
